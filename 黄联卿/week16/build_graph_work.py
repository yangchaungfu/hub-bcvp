...
graph = Graph("bolt://localhost:7687", auth=("neo4j", "demo"))
...
#读取实体-关系-实体三元组文件
with open("triplets_head_rel_tail_liudehua.txt", encoding="utf8") as f:
    for line in f:
...
#读取实体-属性-属性值三元组文件
with open("triplets_enti_attr_value_liudehua.txt", encoding="utf8") as f:
    for line in f:
